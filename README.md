...
| 眼睛 | 由"head 骨→眼球"夹角标定：源 46.8° / 本次 36.2° / 原版 X4 36.0° |
...
| 腿骨朝源的位置拉回 25%（`BORU_LEG_PULL`） | 下半身不再被 X4 的宽骨架撑开 | 顶点略偏离驱动骨，走路时摆幅稍大 |
| 躯干径向放大 8%（`BORU_TORSO`） | 腰臀过渡协调（源比 X4 原版瘦） | 不是源的原始比例 |
| 头绕颈根抬起 5.7°（`BORU_HEAD_TILT`） | 脸朝前，与 X4 原版脸的姿态一致 | 不是源的原始头姿 |
